...
def get_block(grid: tp.List[tp.List[str]], pos: tp.Tuple[int, int]) -> tp.List[str]:
    ...
    ['2', '8', '.', '.', '.', '5', '.', '7', '9']
    """
    coord1, coord2 = pos[0] // 3, pos[1] // 3
    res = [
        *grid[coord1 * 3][coord2 * 3 : coord2 * 3 + 3],
        *grid[coord1 * 3 + 1][coord2 * 3 : coord2 * 3 + 3],
        *grid[coord1 * 3 + 2][coord2 * 3 : coord2 * 3 + 3],
    ]
    return res
...
def solve(grid: tp.List[tp.List[str]]) -> tp.Optional[tp.List[tp.List[str]]]:
    ...
    ['3', '4', '5', '2', '8', '6', '1', '7', '9']]
    """
    space = find_empty_positions(grid)
    if not space:
        return grid
...
def generate_sudoku(N: int) -> tp.List[tp.List[str]]:
    ...
    for i in range(N):
        ...
        empty_grid[ch_pos[0]][ch_pos[1]] = good_solution[ch_pos[0]][ch_pos[1]]
