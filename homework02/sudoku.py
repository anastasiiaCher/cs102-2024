...
def get_block(grid: tp.List[tp.List[str]], pos: tp.Tuple[int, int]) -> tp.List[str]:
    ...
    ['2', '8', '.', '.', '.', '5', '.', '7', '9']
    """
    return [grid[row][col] for row in range(pos[0] - pos[0] % 3, pos[0] - pos[0] % 3 + 3) for col in range(pos[1] - pos[1] % 3, pos[1] - pos[1] % 3 + 3)]
...
def find_empty_positions(grid: tp.List[tp.List[str]]) -> tp.Optional[tp.Tuple[int, int]]:
    ...
    (2, 0)
    """
    return next(((i, j) for i in range(len(grid)) for j in range(len(grid[i])) if grid[i][j] == '.'), False)
...
def check_solution(solution: tp.List[tp.List[str]]) -> bool:
    ...
    True
    >>> check_solution([['5', '3', '4', '6', '7', '8', '9', '5', '2'], ['6', '7', '2', '1', '9', '5', '3', '4', '8'], ['1', '9', '8', '3', '4', '2', '5', '6', '7'], ['8', '5', '9', '7', '6', '1', '4', '2', '3'], ['4', '2', '6', '8', '5', '3', '7', '9', '1'], ['7', '1', '3', '9', '2', '4', '8', '5', '6'], ['9', '6', '1', '5', '3', '7', '2', '8', '4'], ['2', '8', '7', '4', '1', '9', '6', '3', '5'], ['3', '4', '5', '2', '8', '6', '1', '7', '9']])
    False
